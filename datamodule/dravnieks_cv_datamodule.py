...
from src.datamodule.datasets.dravnieks_dataset import DravnieksDataset
from src.utils.iterative_stratification import make_multilabel_stratified_split


class DravnieksDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = "data/dravnieks",
        batch_size: int = 256,
        num_workers: int = 8,
        transform=None,
        **kwargs,
        ...
        super().__init__()
        self.dataset = DravnieksDataset(data_dir, transform=transform)
    ...
    def setup(self, stage: Optional[str] = None):
        dataset = DravnieksDataset(self.data_dir, transform=self.transform)
