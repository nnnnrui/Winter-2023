...
class KellerDataset(InMemoryDataset):
    def __init__(self, root: str = "data/keller", transform=None, pre_transform=None, pre_filter=None):
    ...
    def process(self):
        ...
        target_descriptor = df.columns[4:].values
        molecules_list = df["CanonicalSMILES"].tolist()
